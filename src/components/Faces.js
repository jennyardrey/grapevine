...
const faces = props => {
	...
	return (
		<div className={classes['faces-container']}>
			...
			<h1>If we don't know, we can't help</h1>
			...
			<div>
				{(props.facesClicked === false) ?
					<div className={classes.Faces}>
						<p>Select a face that best describes how you are feeling today </p>
						<button>
					...
					<div className="thankyou-message"><p>Thank you for your input. Your selection has been recorded and will help your employer keep track of general staff happiness. You'll be able to record your mood again next time, but in the mean time, scroll down to leave more detailed feedback.</p></div>}
